...
class _FirstPageState extends State<FirstPage> {
  ...
  late Widget indicatore = Wrap(
      ...
      children: [
        ElevatedButton(onPressed: _connectToServer, child: Text("Cerca un avversario"))
      ]
  );
  ...
  Future<void> drawMyCards(List cards) async {
    ...
    {
      moveCard(lastDrawCard, Offset(x, 700));
      ...
      case "round won":
        await Future.delayed(Duration(seconds: 1), () {
          setState(() {
            ...
            rotazioni[indexOfPlayedCard!] = 1;
            rotazioni[indexOfOpponentCard!] = 1;
          });
          moveCard(indexOfPlayedCard!, Offset(350, 500));
          moveCard(indexOfOpponentCard!, Offset(350, 500));
